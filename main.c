...
int main()
{
   ...
   //main prueba UNION
    ...
    NFA *nfa2 = create_nfa();
    NFA *nfau = create_nfa();
    read_from_file(nfa1, "/home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_15.dot");
    read_from_file(nfa2, "/home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_18.dot");

    nfau = nfa_union(nfa1, nfa2);
    nfa_to_dot(nfau, "/home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_dfa.dot");
    system("xdot /home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_dfa.dot");
    
    DFA *dfa1 = nfa_to_dfa(nfau);
    dfa_to_dot(dfa1, "/home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_dfa.dot");
    system("xdot /home/carlos/Escritorio/Uni/AutomatasYLenguajes/tp1m/nondeterministic-finite-automaton/example-automatons/automata_dfa.dot");
    //fin main prueba
}